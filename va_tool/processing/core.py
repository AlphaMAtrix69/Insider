...
def process_vulnerability_data(vuln_df, kev_set, output_dir, clear_cache_flag=False):
    ...
    processed_df, check_needed_df, analyzed_df, results_data, excluded_df = analyze_vulnerability_data(
        scored_df, kev_set, job_cve_cache
    )
    
    logger.info("Data processing complete")
    return vuln_df, processed_df, check_needed_df, analyzed_df, results_data, excluded_df