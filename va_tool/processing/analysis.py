...
def analyze_vulnerability_data(df, kev_set, cve_cache):
    ...
    # Store excluded entries (Informational, None, Check Needed) AFTER categorization
    excluded_df = result_df[result_df["Risk"].isin(["Informational", "None", "Check Needed"])]
    
    # Split data for analysis
    # Remove informational findings for primary analysis
    filtered_df = result_df[~result_df["Risk"].isin(["None"])]
    ...
    return result_df, check_needed_df, analyzed_df, results, excluded_df
